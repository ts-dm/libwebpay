...
public class WebpayComplete {
    ...
    public WebpayComplete(String url, String commerceCode, SoapSignature signature,
    ...
    public WsCompleteAuthorizeOutput autorize(String token, List<WsCompletePaymentTypeInput> input){

        return port.authorize(token, input);
    }
